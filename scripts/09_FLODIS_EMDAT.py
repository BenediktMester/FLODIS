...
def main():
    ...
    EMDAT['DFO_matches'] = DFO_match_list  
    EMDAT['DFO_matches_nr'] = DFO_match_nr_list  
    EMDAT['matching_type'] = matching_type_list
    EMDAT['DFO_matches_time_dif'] = DFO_match_time_dif_list 
    EMDAT['DFO_duration'] = DFO_duration_list 
    EMDAT['DFO_satellite_shape_area'] = DFO_satellite_shape_area_list
    EMDAT['affected_sum_GHSL'] = affected_GHSL_sum_list 
    EMDAT['affected_mean_GHSL'] = affected_GHSL_mean_list 
    EMDAT['DFO_satellite_shape_pop_density_GHSL'] = DFO_satellite_shape_pop_density_GHSL_list 
    EMDAT['affected_sum_GPW'] = affected_GPW_sum_list 
    EMDAT['affected_mean_GPW'] = affected_GPW_mean_list 
    EMDAT['DFO_satellite_shape_pop_density_GPW'] = DFO_satellite_shape_pop_density_GPW_list 
